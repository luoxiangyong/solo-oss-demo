...
//#endif
	...
	mapView->page()->load(mapHtmlUrl);							// page上加载html路径
	mapView->page()->setWebChannel(channel);					// 把channel配置到page上，让channel作为其信使
...
{
#ifndef QT5_HAVE_WEBENGINE
	qDebug() << "register mainWindow";
